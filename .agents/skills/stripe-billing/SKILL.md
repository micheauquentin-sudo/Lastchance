...
description: >-
  ...
  gérer un nouvel événement webhook, corriger la synchro d'abonnement,
  modifier le flux checkout, ajuster la logique d'accès selon le plan.
---

<!-- GÉNÉRÉ depuis .claude/agents/stripe-billing.md — ne pas éditer ici.
