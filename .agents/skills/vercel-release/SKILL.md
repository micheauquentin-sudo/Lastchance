...
description: >-
  ...
  inspections, logs, promotions et rollbacks. Il coordonne l'ordre migration
  Supabase puis application Vercel, sans modifier la logique métier.
---

<!-- GÉNÉRÉ depuis .claude/agents/vercel-release.md — ne pas éditer ici.
