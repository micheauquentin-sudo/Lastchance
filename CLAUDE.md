...
**Branch** : `main`, sur **les deux dépôts**, arbres propres. Aucune PR ouverte,
aucune branche de chantier ; il ne subsiste sur le distant que
`claude/merchant-mvp-build-w8j7et` (direction artistique jamais appliquée) et
`claude/saas-security-audit-8z3zvv` (conservée pour
`create_campaign_with_defaults`), toutes deux documentées dans `docs/bugs.md`.
Migrations à jour jusqu'à `20260805240000`, production déployée et saine.
