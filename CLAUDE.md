...
## Last Updated
- **Date**: 2026-08-29
- **Dernier chantier**: **Réservation de table : un plan de salle, puis le défaut qui l'empêchait de tourner** (RDV-1, RDV-6 à RDV-9, RDV-11, RDV-12 — PR #229→#232, #237). Réservation (`rendez_vous`) a des tables nommées, un effectif exact, une liste d'attente qui **notifie** sans tenir de table. RDV-11 a corrigé `createReserverActivity` : n'écrivait pas `booking_mode`, tout naissait `moment` et sortait du filtre de la page.
