  ...
  return (
    <LegalPage title="Politique de confidentialité">
      ...
      <LegalSection title="Responsabilités et finalités">
        <p>Le commerçant qui organise le jeu est responsable des données de ses clients. LastChance les traite pour exécuter le jeu, prévenir la fraude, remettre les gains, assurer la sécurité et, avec consentement, envoyer les communications demandées. Les prestataires techniques peuvent inclure Supabase, Cloudflare, Resend, Stripe, Sentry et, après consentement, PostHog. Si le commerçant active le canal SMS, le numéro de téléphone du destinataire est transmis à Brevo pour l&apos;envoi. Si la protection anti-abus est configurée avec un service de compteurs externe, Upstash traite l&apos;adresse IP à cette seule fin.</p>
      </LegalSection>
