...
export default async function QuizDetailPage({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ── LE STUDIO EST LE CHEMIN PRINCIPAL SUR GRAND ÉCRAN (VIT-41) ──

          Tout s'y règle en voyant la question du client. La carte est donc
          OUVERTE d'emblée : un commerçant qui vient régler quelque chose doit
          ...
          motif, que `/dashboard/vitrine` et `/dashboard/calendar`.
          ...
          <Card>
            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
              <p className="min-w-0 flex-1 text-sm text-k-body">
                La question de vos clients au centre, les réglages autour. Le
                nom, l&apos;habillage, les questions, ce qu&apos;on gagne, le lot
                et le partage — tout s&apos;y règle en voyant le résultat.
              </p>
              <Link
                href={`/studio/quiz/${quiz.id}`}
