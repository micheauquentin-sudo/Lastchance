...
/**
 * L'erreur est CAPTURÉE, jamais affichée — motif de `/poster/error.tsx`.
 *
 ...
 *
 * ── LA SORTIE DE SECOURS MÈNE À L'ATELIER, PAS À L'ACCUEIL ──
 *
 * Ce studio est plein écran : il n'a ni menu ni fil d'Ariane. Un commerçant
