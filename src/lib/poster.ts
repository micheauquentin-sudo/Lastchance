...
export const POSTER_TEMPLATES: PosterTemplate[] = [
  ...
  // Modèles par secteur : couleurs + texte déjà rédigés, prêts à imprimer.
  template("cafe", "Café / Restaurant", ["#fffbeb", "#b45309", "#292524"], {
    bgFrom: "#fffbeb",
    bgTo: "#fef3c7",
    accent: "#b45309",
    textColor: "#292524",
    ...
    footer: "Jeu gratuit sans obligation d'achat",
  }),
  template("beauty", "Coiffure / Beauté", ["#fdf2f8", "#db2777", "#831843"], {
    bgFrom: "#fdf2f8",
    bgTo: "#fce7f3",
    accent: "#db2777",
    textColor: "#831843",
    font: "rounded",
    title: "Prenez soin de vous, tentez votre chance !",
    subtitle: "Un soin, une remise, une jolie surprise…",
    step1: "Scannez le QR code",
    step2: "Tournez la roue",
    step3: "Présentez votre gain à l'accueil",
    footer: "Jeu gratuit sans obligation d'achat",
  }),
  template("shop", "Boutique / Commerce", ["#eff6ff", "#2563eb", "#1e3a8a"], {
    bgFrom: "#eff6ff",
    bgTo: "#dbeafe",
    accent: "#2563eb",
    textColor: "#1e3a8a",
    font: "sans",
    title: "Un cadeau vous attend en boutique !",
    subtitle: "Scannez et tentez votre chance.",
    step1: "Scannez le QR code",
    step2: "Tournez la roue",
    step3: "Montrez votre gain en caisse",
    footer: "Jeu gratuit sans obligation d'achat",
  }),
  template("bar", "Bar / Nightlife", ["#18181b", "#f59e0b", "#ffffff"], {
    bgFrom: "#18181b",
    bgTo: "#000000",
    accent: "#f59e0b",
    textColor: "#ffffff",
    font: "impact",
    title: "Tournez, gagnez, trinquez !",
    subtitle: "Une tournée offerte, peut-être ?",
    step1: "Scannez le QR code",
    step2: "Tournez la roue",
    step3: "Montrez votre gain au bar",
    footer: "Jeu gratuit sans obligation d'achat — 18 ans et plus",
  }),
];
