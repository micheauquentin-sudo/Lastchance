...
| --- | --- | --- | --- |
| 2026-08-19 | Mesure Codex, lecture seule — volume de cartes France et cache Vitrine | **Échantillon indicatif, non statistique nationale :** 10 cartes françaises publiques, contenu alimentaire seulement (prix, navigation, contacts et boissons/vins exclus), donnent ~77–780 mots et ~0,5–5,2 k caractères par carte ; médiane ~270 mots/~1,8 k caractères. Hypothèse prudente de produit : **2 k caractères traduisibles par Vitrine**. Pour 50 commerces et une langue cible : 100 k caractères bruts, ou ~85 k après 15 % de réemploi global, donc **0 USD** sous le quota Google de 500 k/mois ; 10 % de mises à jour mensuelles = ~8,5 k caractères, toujours 0 USD. La mémoire globale économise surtout catégories, labels de régimes, 14 noms d'allergènes et ingrédients structurés exacts ; elle ne rend pas gratuit un titre/une description contenant seulement un mot connu. Titres, descriptions, noms signature, prix, origine, disponibilité et associations plat→allergène restent privés par organisation/version ; ne jamais inférer un allergène du texte. | Recommandation : conserver deux caches et une limite de dépense, mais ne pas sur-optimiser les coûts à 50 commerces. Détail des sources, méthode et calculs : `docs/vitrine-traduction-benchmark-2026-08-19.md`. À re-mesurer sur les premières Vitrines réelles avant toute promesse de volume. |
