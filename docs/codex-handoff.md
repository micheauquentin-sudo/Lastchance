...
| 2026-08-17 | Clarification produit utilisateur — **LastChance Vitrine** | La Vitrine doit présenter le commerce lui-même autant que ses plats, produits ou prestations : histoire/ambiance/savoir-faire du lieu, sélections éditoriales et fiches de découverte. Elle mène ensuite vers la Boussole, une réservation, une file, une invitation ou un retrait limité. Promesse : « Faites découvrir votre lieu et ce que vous proposez, puis faites réserver le bon moment. » Elle reste sans caisse, commande, livraison, synchronisation POS ou stock temps réel au MVP. | Proposition prête à arbitrer avant ajout au développement ; ne pas la réduire à un catalogue froid ni l'étendre à un e-commerce. |
